    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
          ...
          {/* 1st block */}
          <div className="sm:col-span-12 lg:col-span-4 lg:max-w-xs hidden">
            <div className="mb-2">
              {/* Logo */}
              <Logo />
            </div>
            <div className="text-lg font-bold text-slate-800">以更明智的方式开始您的下一次投资</div>
          </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-6 md:py-8 border-t border-slate-200">
          ...
          {/* Social links */}
          <ul className="flex space-x-6 mb-4 md:order-1 md:ml-4 md:mb-0 hidden">
            <li>
          ...
          {/* Copyrights note */}
          <div className="text-sm text-slate-500 mr-4">© tcpgolbal.github.io. All rights reserved.</div>
